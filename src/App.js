          ...
          <div class="heatmap-wrapper">
            ...
            <section class="heatmaps">
              <div class="call-heatmap">
                ...
                <img key={heatmaps[0].filename} src={heatmaps[0].url} alt={heatmaps[0].filename} class="heatmap-image"/>
              </div>
              <div class="put-heatmap">
                <strong>PUT Heatmap</strong>
                <img key={heatmaps[1].filename} src={heatmaps[1].url} alt={heatmaps[1].filename} class="heatmap-image"/>
              </div>
            </section>
            ) : (
